...
-- 索引
CREATE INDEX idx_magic_library_workspace ON magic_library(workspace_id);
CREATE INDEX idx_magic_library_category ON magic_library(category);
CREATE INDEX idx_magic_library_layer ON magic_library(layer);
CREATE INDEX idx_magic_library_status ON magic_library(update_status);
