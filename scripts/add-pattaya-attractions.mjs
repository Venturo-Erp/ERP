...
const newAttractions = [
  ...
  { name: '春武里大峽谷', english_name: 'Grand Canyon Chonburi', category: '景點', type: '自然景觀' },
  { name: '芭達雅海底世界', english_name: 'Underwater World Pattaya', category: '景點', type: '自然景觀' },
  ...
  { name: '羅摩衍那水上樂園', english_name: 'Ramayana Water Park', category: '景點', type: '主題樂園' },
  { name: '暹羅傳奇樂園', english_name: 'Legend Siam Pattaya', category: '景點', type: '主題樂園' },
  { name: '哥倫比亞影業水世界', english_name: 'Columbia Pictures Aquaverse', category: '景點', type: '主題樂園' },
  { name: '暹羅冰雪世界', english_name: 'Frost Magical Ice of Siam', category: '景點', type: '主題樂園' },
  ...
  { name: 'GREAT&GRAND Sweet Destination', english_name: 'GREAT&GRAND Sweet Destination', category: '景點', type: '主題樂園' },
  ...
  { name: '美人魚餐廳', english_name: '3 Mermaids Cafe & Restaurant', category: '餐廳', type: '主題餐廳' },
  ...
  { name: 'Baan Mae Sri 豬雜湯', english_name: 'Baan Mae Sri Pork Blood Soup', category: '餐廳', type: '當地小吃' },
  
  // 表演
  { name: '羅馬金宮劇場人妖秀', english_name: 'Colosseum Show Pattaya', category: '景點', type: '表演秀' },
  ...
  { name: 'All Star 全明星號遊輪', english_name: 'All Star Cruise', category: '景點', type: '遊輪' },
  { name: '沙美島火舞餐廳', english_name: 'Fire Show Koh Samet', category: '餐廳', type: '表演餐廳' },
  { name: 'Max 泰拳比賽', english_name: 'Max Muay Thai', category: '景點', type: '表演秀' },
  
  // 購物
  { name: '尚泰芭提雅購物中心', english_name: 'Central Pattaya', category: '購物', type: '購物中心' },
  { name: '信不信由你博物館', english_name: 'Ripleys Believe it or not', category: '景點', type: '博物館' },
  
  // 動物
  { name: '綠山動物園', english_name: 'Khao Kheow Open Zoo', category: '景點', type: '動物園' },
  { name: '鱷魚農場', english_name: 'Million Years Stone Park & Crocodile Farm', category: '景點', type: '動物園' },
  ...
  // 視野體驗
  { name: '將軍山觀景台', english_name: 'Phra Tamnak Mountain Viewpoint', category: '景點', type: '觀景台' },
  { name: 'Pattaya Park Tower', english_name: 'Pattaya Park Tower', category: '景點', type: '高空體驗' }
];
...
let pattayaCityId = cities?.find(c => 
  c.name.includes('芭達雅') || 
  c.name.includes('芭堤雅') ||
