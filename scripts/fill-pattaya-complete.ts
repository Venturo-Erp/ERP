...
> = {
  七珍佛山: {
    description:
      '《七珍佛山》是春武里府最大的戶外佛像雕刻，金色佛像高109公尺、寬70公尺，刻於垂直山壁上。這座巨型佛像由泰國皇室下令建造，紀念泰皇登基50週年。佛像表面覆以金箔，在陽光下閃耀奪目；山腳花園池塘環繞，氣氛寧靜莊嚴，是芭達雅近郊必訪的文化地標。',
  ...
  芭達雅海底世界: {
    description:
      '《芭達雅海底世界》位於市中心，擁有100公尺長的海底隧道，遊客可近距離觀賞鯊魚、魟魚、海龜等數千種海洋生物。館內分為淡水區、珊瑚礁區、深海區，每日定時餵食秀吸引大批遊客。對親子旅遊極為友善，互動式展示讓孩子認識海洋生態，是雨天的最佳備案。',
  ...
  羅摩衍那水上樂園: {
    description:
      '《羅摩衍那水上樂園》是泰國最大的水上主題樂園，佔地18萬平方公尺，以印度史詩《羅摩衍那》為主題。園區擁有50多項遊樂設施，包括亞洲最高的滑水道、人工海浪池、漂漂河。建築風格融合泰式與印度神話元素，巨大雕像與精緻園藝令人驚艷，夏季消暑首選。',
  ...
  暹羅冰雪世界: {
    description:
      '《暹羅冰雪世界》是東南亞最大的冰雕樂園，室內溫度常年保持零下10度。展區分為冰雕藝術區、冰滑梯遊樂區、極地動物區，所有雕塑皆由中國哈爾濱冰雕師傅製作。遊客租借厚重外套入內，體驗熱帶國家難得的冰雪世界，冰吧提供特調冰飲，是炎夏獨特體驗。',
  ...
  寶妮小馬俱樂部: {
    description:
      '《寶妮小馬俱樂部》是芭達雅郊區的家庭式馬場，提供小型馬（Pony）騎乘體驗，特別適合兒童。除了騎馬課程，還有餵食、梳理馬匹的互動活動。園區環境整潔，教練親切專業，強調動物福利。對於初次接觸馬術的孩子，這裡是最溫和的入門選擇，也是親子旅遊的溫馨記憶。',
