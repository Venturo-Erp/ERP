...
// 要發掘的目標城市（優先泰國清邁）
const TARGET_CITIES = [
  { countryId: 'thailand', countryName: '泰國', countryEn: 'Thailand', cityId: 'chiang-mai', cityZh: '清邁', cityEn: 'Chiang Mai' },
  { countryId: 'thailand', countryName: '泰國', countryEn: 'Thailand', cityId: 'bangkok', cityZh: '曼谷', cityEn: 'Bangkok' },
];
...
async function main() {
  ...
  allDiscovered.sort((a,b) => {
    ...
    const order = { street_food: 1, restaurant: 2, cafe: 3, attraction: 4, museum: 5, historic: 6, beach: 7, park: 8, market: 9, night_market: 10, guesthouse: 11, hotel: 12, resort: 13, villa: 14 };
