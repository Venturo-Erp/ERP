      ...
      <div className="p-8 max-w-2xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <Button
            onClick={handleStart}
            disabled={!canStart}
            className="w-full bg-gradient-to-br from-morandi-gold/40 to-morandi-container/60 text-morandi-primary ring-1 ring-border/50 hover:from-morandi-gold/60 hover:to-morandi-container/80 shadow-md hover:shadow-lg h-12 text-base"
          >
