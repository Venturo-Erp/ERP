        ...
        <div className="space-y-4">
          ...
          <div className="bg-morandi-container rounded-lg p-4 space-y-3">
            ...
            <div className="border-t pt-3 space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-morandi-secondary">停車費</span>
                <span>{response?.includesParking ? '✓ 含' : '✗ 不含'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-morandi-secondary">過路費</span>
                <span>{response?.includesToll ? '✓ 含' : '✗ 不含'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-morandi-secondary">司機住宿</span>
                <span>
              ...
              <div className="flex justify-between">
                <span className="text-morandi-secondary">司機小費</span>
                <span>
            ...
            {response?.supplierNote && (
              <div className="border-t pt-3">
                <span className="text-morandi-secondary text-sm">備註</span>
            ...
            <div className="border-t pt-3 text-xs text-muted-foreground">
              ...
              <div>
                報價時間：
                {quote.replied_at ? new Date(quote.replied_at).toLocaleString('zh-TW') : '-'}
              </div>
            </div>
          </div>
          ...
          {showCancel ? (
            ...
            <div className="space-y-3">
              <div>
                <label className="text-sm text-morandi-primary">取消原因（選填）</label>
                <input
                  type="text"
                  value={cancelReason}
