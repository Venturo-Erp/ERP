...
export const paymentRequestItemEntity = createEntityHook<PaymentRequestItem>(
  'payment_request_items',
  {
    list: {
      select:
        'id,request_id,item_number,category,supplier_id,supplier_name,description,notes,tour_id,tour_request_id,quantity,unitprice,subtotal,payment_method,custom_request_date,sort_order,workspace_id,created_at,created_by,updated_at,updated_by,advanced_by,advanced_by_name',
