...
const supplierEntity = createEntityHook<Supplier>('suppliers', {
  ...
  slim: {
    select:
      'id,code,name,category_id,contact_person,phone,email,bank_name,bank_code_legacy,bank_account,bank_account_name,notes,type',
  },
  detail: { select: '*' },
...
const useSupplier = supplierEntity.useDetail
const useSuppliersPaginated = supplierEntity.usePaginated
const useSupplierDictionary = supplierEntity.useDictionary
