...
const useCalendarEventsSlim = calendarEventEntity.useListSlim
const useCalendarEvent = calendarEventEntity.useDetail
const useCalendarEventsPaginated = calendarEventEntity.usePaginated
const useCalendarEventDictionary = calendarEventEntity.useDictionary
