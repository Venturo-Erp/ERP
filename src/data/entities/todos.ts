...
export const todoEntity = createEntityHook<Todo>('todos', {
  list: {
    select:
      'id,title,priority,deadline,status,completed,created_by_legacy,assignee,visibility,related_items,sub_tasks,notes,enabled_quick_actions,needs_creator_notification,created_at,updated_at,workspace_id,created_by,updated_by,is_public,task_type,tour_request_id,tour_id',
