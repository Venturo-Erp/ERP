...
export const AIRPORT_COORDINATES: Record<string, AirportCoordinate> = {
  ...
  NRT: { code: 'NRT', name: '成田機場', city: '東京', latitude: 35.7720, longitude: 140.3929 },
  ...
  ITM: { code: 'ITM', name: '伊丹機場', city: '大阪', latitude: 34.7855, longitude: 135.4380 },
  NGO: { code: 'NGO', name: '中部國際機場', city: '名古屋', latitude: 34.8584, longitude: 136.8123 },
  ...
  SDJ: { code: 'SDJ', name: '仙台機場', city: '仙台', latitude: 38.1397, longitude: 140.9170 },
  AOJ: { code: 'AOJ', name: '青森機場', city: '青森', latitude: 40.7347, longitude: 140.6906 },
  HKD: { code: 'HKD', name: '函館機場', city: '函館', latitude: 41.7700, longitude: 140.8219 },
  ...
  MMY: { code: 'MMY', name: '宮古機場', city: '宮古', latitude: 24.7828, longitude: 125.2950 },
  ...
  KHH: { code: 'KHH', name: '高雄機場', city: '高雄', latitude: 22.5771, longitude: 120.3500 },
  
  // 東南亞
  BKK: { code: 'BKK', name: '素萬那普機場', city: '曼谷', latitude: 13.6900, longitude: 100.7501 },
  ...
  SGN: { code: 'SGN', name: '新山一機場', city: '胡志明市', latitude: 10.8188, longitude: 106.6519 },
  ...
  HKG: { code: 'HKG', name: '香港機場', city: '香港', latitude: 22.3080, longitude: 113.9185 },
  ...
  CSX: { code: 'CSX', name: '長沙機場', city: '長沙', latitude: 28.1892, longitude: 113.2200 },
  WUH: { code: 'WUH', name: '天河機場', city: '武漢', latitude: 30.7838, longitude: 114.2081 },
  NKG: { code: 'NKG', name: '祿口機場', city: '南京', latitude: 31.7420, longitude: 118.8622 },
  HGH: { code: 'HGH', name: '蕭山機場', city: '杭州', latitude: 30.2295, longitude: 120.4343 },
  XMN: { code: 'XMN', name: '高崎機場', city: '廈門', latitude: 24.5440, longitude: 118.1277 },
