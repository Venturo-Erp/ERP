        ...
        <div className="px-6 py-4 border-t border-border flex items-center justify-end gap-3">
          ...
          {onCropAndSave ? (
            <Button
              ...
              className="bg-gradient-to-br from-morandi-gold/40 to-morandi-container/60 text-morandi-primary ring-1 ring-border/50 hover:from-morandi-gold/60 hover:to-morandi-container/80 shadow-md hover:shadow-lg gap-1.5"
            >
