...
export async function POST(req: NextRequest) {
  try {
    ...
    // 建立公開連結
    const publicUrl = `${process.env.NEXT_PUBLIC_APP_URL || 'https://app.cornertravel.com.tw'}/public/meal-quote/${tourId}/${requestId}`

    // 組成 LINE Flex Message
    const flexMessage = {
      type: 'flex',
      altText: `餐食需求單 - ${tourName}`,
      contents: {
        type: 'bubble',
        header: {
          type: 'box',
