    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <h1 className="text-xl font-bold text-gray-800 mb-2">找不到預訂資訊</h1>
          <p className="text-gray-600">連結可能已失效或預訂已取消</p>
        </div>
      </div>
    )
  }
  ...
  if (item.booking_confirmed_at) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          <div className="text-6xl mb-4">✅</div>
          <h1 className="text-xl font-bold text-gray-800 mb-2">已確認</h1>
          <p className="text-gray-600 mb-4">司機資訊已提交，感謝您的配合！</p>
          <div className="bg-gray-50 rounded-lg p-4 text-left text-sm">
            <div className="grid grid-cols-2 gap-2">
              ...
              <span className="text-gray-500">車款</span>
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-lg mx-auto">
        ...
        <div className="bg-white border-x border-gray-200 p-6">
          <h2 className="font-medium text-gray-700 mb-3">團體資訊</h2>
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div className="col-span-2">
              <span className="text-gray-500">團名</span>
