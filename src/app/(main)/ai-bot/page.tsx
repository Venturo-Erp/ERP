...
import { Bot, MessageCircle, Users, User, Link2, Search, RefreshCw, Settings, MessagesSquare } from 'lucide-react'
...
export default function AIBotManagementPage() {
  ...
  return (
    <ContentPageLayout
      ...
      icon={Bot}
      headerActions={
        <Button onClick={() => { loadConfig(); loadData() }} variant="outline" disabled={loading} size="sm">
      ...
      <div className="max-w-6xl mx-auto space-y-6 p-6">
        ...
        <Tabs defaultValue="platform">
          ...
          <TabsContent value="platform" className="mt-4 space-y-6">
            ...
            <div>
              <h3 className="text-sm font-semibold text-morandi-secondary mb-3 flex items-center gap-2">
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 2.136.67 4.116 1.81 5.74L2 22l4.26-1.81A9.94 9.94 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2z"/></svg>
                Meta 平台
              </h3>
              <Card>
                <CardContent className="py-5 space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        透過同一個 Meta App 同時接收 Instagram 私訊和 Facebook Messenger 訊息，由 AI 統一回覆。
                      </p>
                    </div>
                    <Badge variant="outline" className="shrink-0">準備中</Badge>
                  </div>
                  <div className="border-t pt-3">
                    ...
                    <ol className="list-decimal list-inside space-y-1.5 text-sm text-morandi-secondary">
                      <li>前往 <a href="https://developers.facebook.com/" target="_blank" rel="noopener noreferrer" className="text-morandi-gold underline">Meta for Developers</a> 註冊開發者帳號</li>
                      <li>建立一個 App → 選擇 <strong>Business</strong> 類型</li>
                      <li>在 App 中加入 <strong>Messenger</strong> 和 <strong>Instagram</strong> 產品</li>
